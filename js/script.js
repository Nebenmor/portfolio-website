 // Mobile menu toggle with enhanced UX
      ...
      ScrollReveal().reveal(".home-img, .services-container, .portfolio-box, .contact-container", { 
        origin: "bottom",
        interval: 200
      });
      ScrollReveal().reveal(".home-content h1, .about-img, .skills-grid .skill-category:nth-child(odd)", { 
        origin: "left",
        interval: 200
      });
      ScrollReveal().reveal(".home-content p, .about-content, .skills-grid .skill-category:nth-child(even)", { 
        origin: "right",
        interval: 200
      });
      ...
      const typed = new Typed(".multiple-text", {
        strings: ["Full-Stack Dev", "React.js Dev", "Problem Solver"],
        typeSpeed: 80,
        backSpeed: 60,
        backDelay: 1200,
        loop: true,
      ...
      document.querySelectorAll('section, .skill-category, .services-box, .portfolio-box').forEach(el => {
        observer.observe(el);
      });
